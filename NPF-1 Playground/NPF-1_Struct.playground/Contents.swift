...
struct Park: CustomStringConvertible {
    ...
    mutating func getParkName() -> String {
        parkName
    }
...
var p2 : Park = Park(parkName: "Acadia National Park", parkLocation: "Maine", dateFormed: "1919-02-26", area: "47,389.67 acres (191.8 squarekm)", link: "TBD", location: nil,
